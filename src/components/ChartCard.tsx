  ...
  return (
    <Card className="rounded-xl bg-[#252525] p-4 w-full border-0 border-none h-[320px] flex flex-col">
      <div className="flex flex-col items-center flex-1">
        <h3 className="text-[20px] font-normal text-foreground h-[28px] flex items-center">{title}</h3>
        ...
        <p className="text-muted-foreground text-center text-[13px] max-w-[150px] h-[50px] flex items-center justify-center">
          {scoreDefinition}
        </p>
      </div>
    </Card>
